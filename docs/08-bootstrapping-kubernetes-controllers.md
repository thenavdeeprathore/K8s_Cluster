...
The commands in this lab must be run on each controller instance: `master-1`. Login to each controller instance using SSH Terminal. Example:
...
> Remember to run the above commands on each controller node: `master-1`.
