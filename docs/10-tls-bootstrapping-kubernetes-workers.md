...
In one of the previous steps we created the kube-proxy.kubeconfig file. Check [here](https://github.com/thenavdeeprathore/K8s_Cluster/blob/master/docs/05-kubernetes-configuration-files.md) if you missed it.
